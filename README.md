...
```
	...
	IMD	; refere-se a um número imediato geralmente com 16 bits de comprimento, exceto no caso
                ; de ROL e ROR, que podem ser expressos tanto em decimal quanto em hexadecimal
